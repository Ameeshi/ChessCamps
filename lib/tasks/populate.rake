namespace :db do
  ...
  task :populate => :environment do
    ...
    dates = [[Date.new(2021,6,11),Date.new(2021,6,15)],
             [Date.new(2021,6,18),Date.new(2021,6,22)],
             [Date.new(2021,6,25),Date.new(2021,6,29)],
             [Date.new(2021,7,9),Date.new(2021,7,13)],
             [Date.new(2021,7,16),Date.new(2021,7,20)],
             [Date.new(2021,7,23),Date.new(2021,7,27)],
             [Date.new(2021,7,30),Date.new(2021,8,3)],
             [Date.new(2021,8,6),Date.new(2021,8,10)],
             [Date.new(2021,8,13),Date.new(2021,8,17)],
             [Date.new(2021,8,20),Date.new(2021,8,24)]]
