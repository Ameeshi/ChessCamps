Feature: Manage curriculums
  ...
  To make sure the core of my business runs correctly

  Background:
    Given an initial setup

  # READ METHODS
  Scenario: No curriculums yet
    Given no setup yet
    When I go to the curriculums page
    And I should see "There are no curriculums in the system at this time"
    And I should not see "Name"
    And I should not see "Min Rating"
    And I should not see "Max Rating"
  ...
  Scenario: Creating a new curriculum is successful
    ...
    Then I should see "Benko Gambit"
  ...
  Scenario: Updating an existing curriculum is successful
    ...
    Then I should see "Nimzo-Indian Defense"
